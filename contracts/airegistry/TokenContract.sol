...
contract TokenContract is AiRegistryModifiers {
    ...
    uint256 constant PRIVATE_NOTE_CODE_HASH  = 0x097cf46b4c899e3ebc5a0178ca104d233a18a5623a9fb381415c9acb62d36b67;
    ...
    function _burnShell(uint128 amount) private pure {
        ...
        // probe tick / commission) is burned in chunks rather than a single truncated
        // call, so the whole amount is burned ("burn both, nothing to either side").
